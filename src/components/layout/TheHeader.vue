    ...
    <div id="menuToggle">
      ...
      <ul id="menu">
        <li>
          ...
          <router-link to="/portes-ouvertes-2022/allactivities">Toutes les activités</router-link>
        </li>
        <li>
          ...
          <router-link to="/portes-ouvertes-2022/createactivity">Créer une activité</router-link>
        </li>
        <li>
          ...
          <router-link to="/portes-ouvertes-2022/playanactivity">Jouer</router-link>
        </li>
        <li>
          ...
          <router-link to="/portes-ouvertes-2022/user">Utilisateur</router-link>
        </li>
  ...
  methods: {
    ...
    handleSignOut() {
      ...
      setTimeout(() => {
        let auth = getAuth();
        signOut(auth).then(() => {
          this.$router.push({ path: '/portes-ouvertes-2022/user' })
        })
      }, 500)
